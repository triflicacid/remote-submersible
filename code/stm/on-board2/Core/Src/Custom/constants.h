...
#define DC_MOTOR_EN1_2 GPIO_PIN_5
#define DC_MOTOR_EN3_4 GPIO_PIN_10

// dc motor enable pins: PWM channels
#define DC_MOTOR_EN1_2_PWM_CHANNEL TIM_CHANNEL_1
#define DC_MOTOR_EN3_4_PWM_CHANNEL TIM_CHANNEL_2
